...
const Claymorphism = styled(Base)`
  background: ${ ({theme}) => theme.colors.gray.c175 };
  box-shadow:
    inset -8px -8px 16px 0px ${ ({theme}) => theme.colors.gray.c675 },
    inset 8px 8px 16px 0px ${ ({theme}) => theme.colors.gray.c025 },
    16px 16px 32px 0px ${ ({theme}) => theme.colors.gray.c975 }48
  ;
  &:hover {
    background: ${ ({theme}) => theme.colors.gray.c250 };
  }
`

const Glassmorphism = styled(Base)`
  color: ${ ({theme}) => theme.colors.gray.c825 };
  background: ${ ({theme}) => theme.colors.gray.c025 }16;
  border-bottom: solid 2px ${ ({theme}) => theme.colors.gray.c250 }48;
  border-right: solid 2px ${ ({theme}) => theme.colors.gray.c250 }48;
  border-top: solid 2px ${ ({theme}) => theme.colors.gray.c100 }64;
  border-left: solid 2px ${ ({theme}) => theme.colors.gray.c100 }64;
  box-shadow: 24px 24px 48px 0px ${ ({theme}) => theme.colors.gray.c975 }48;
  backdrop-filter: blur(8px);
  &:hover {
    background: ${ ({theme}) => theme.colors.gray.c025 }32;
  }
`
...
const ContainerForDiference = styled.div`
  ...
  align-items: center;
  /* border-radius: 16px; */
  background: ${ ({theme}) => theme.colors.gray.c175 }E0;
  z-index: 2;
`
